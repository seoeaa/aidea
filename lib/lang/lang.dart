mixin AppLocale {
  ...
  static const Map<String, dynamic> ru = {
    ...
    messageInputTips: 'Задайте мне вопрос...',
    uploadImage: 'Загрузить',
    longPressSpeak: 'Удерживайте для записи',
    send: 'Отправить',
    uploading: 'Загрузка...',
    robotIsThinkingMessage: 'Думает...',
    robotHasSomeError: '❗️Произошла ошибка',
    appName: 'AIdea',
    chatAnywhere: 'Чат',
    homeTitle: 'Персонажи',
    creativeIsland: 'Творчество',
    settings: 'Настройки',
    language: 'Язык',
    themeMode: 'Тема',
    accountInfo: 'Информация об аккаунте',
    usage: 'Монеты',
    validBefore: 'Действительно до',
    custom: 'Настроить',
    ...
    retrievePassword: 'Забыли пароль',
    newPassword: 'Новый пароль',
    account: 'Аккаунт',
    usedUp: 'Использовано',
    expired: 'Истекло',
    room: 'Персонаж',
    createRoom: 'Создать персонажа',
    model: 'Модель ИИ',
    ...
    search: 'Поиск',
    background: 'Фон',
    backgroundSetting: 'Настройки фона',
    roomSetting: 'Настройки персонажа',
    chatHistory: 'История чата',
    confirmSend: 'Подтвердить отправку?',
    questionExamples: 'Примеры вопросов',
    noRecords: 'Нет записей',
    contextBreakMessage: '~ Контекст очищен ~',
    noMessageSelected: 'Нет выбранных сообщений',
    modelUsage:
        'Модель используется для настройки типа используемого ИИ-персонажа',
    promptUsage: 'Подсказка используется для настройки поведения ИИ-персонажа',
    nameRequiredMessage: 'Пожалуйста, введите имя персонажа',
    promptFormatError: 'Подсказка не может содержать более 1000 символов',
    operateSuccess: 'Успешно',
    operateFailed: 'Не удалось',
    confirmDelete: 'Подтвердить удаление?',
    confirmStartNewChat: 'Подтвердить начало нового чата?',
    confirmClearMessages: 'Подтвердить очистку истории чата?',
    quotaExceeded: 'Недостаточно монет, пожалуйста, сначала приобретите их',
    internalServerError:
        'Внутренняя ошибка сервера, пожалуйста, попробуйте позже',
    badGateway:
        'Извините, наш сервер в данный момент не может обработать ваш запрос. Мы работаем над устранением проблемы, пожалуйста, попробуйте позже',
    modelNotValid: 'Текущая модель недоступна',
    signInRequred: 'Вы не вошли в систему, пожалуйста, войдите сначала',
    accountNeedReSignin: 'Проблемы с аккаунтом, пожалуйста, войдите снова',
    openAIAuthFailed:
        'Вы включили настраиваемую службу OpenAI, пожалуйста, проверьте правильность ключа API',
    confirmToDeleteRoom: 'Подтвердить удаление персонажа?',
    writeYourIdeas: 'Ваши идеи',
    describeYourImages: 'Опишите ваши изображения',
    excludeContents: 'Отрицательные подсказки',
    autoTranslateToEnglish: 'Автоматический перевод на английский',
    auto: 'Авто',
    style: 'Стиль',
    ...
    contentIsRequired: 'Требуется содержание',
    wordCountInvalid: 'Количество слов не может превышать 1000',
    generateTimeout: 'Тайм-аут генерации, пожалуйста, попробуйте позже',
    creativeIslandNeedSignIn:
        'Разблокируйте больше функций после входа в систему',
    generateResult: 'Результат генерации',
    generateExitConfirm:
        'Генерация...\nВы можете просмотреть результат в истории',
    tooManyRequests: 'Слишком много запросов, пожалуйста, попробуйте позже',
    promptHint:
        'Установите роль и навыки персонажа, чтобы он мог предоставлять более точную и эффективную информацию для вас.',
    confirmClearCache: 'Подтвердить очистку кеша?',
    confirmSignOut: 'Подтвердить выход?',
    followSystem: 'Следовать системе',
    darkThemeMode: 'Темный режим',
    lightThemeMode: 'Светлый режим',
    forgotPassword: 'Забыли пароль',
    createAccount: 'Создать аккаунт',
    useAsClient: 'Использовать как клиент OpenAI',
    signInWithApple: 'Войти через Apple',
    readAndAgree: 'Я прочитал ',
    andWord: 'и',
    accountInputTips: 'Введите свой номер телефона',
    phoneInputTips: 'Введите свой номер телефона',
    passwordInputTips: 'Введите свой пароль',
    pleaseReadAgreeProtocol:
        'Пожалуйста, сначала прочтите и согласьтесь с пользовательским соглашением и политикой конфиденциальности',
    signInSuccess: 'Вход успешен',
    signInFailed: 'Ошибка входа',
    accountRequired: 'Пожалуйста, введите свой аккаунт',
    accountFormatError:
        'Ошибка формата аккаунта\nПожалуйста, введите свой номер телефона',
    phoneNumberFormatError: 'Ошибка формата номера телефона',
    passwordRequried: 'Пожалуйста, введите свой пароль',
    passwordFormatError:
        'Ошибка формата пароля\nДолжен состоять из 8-20 цифр, букв и специальных символов',
    accountCreated: 'Аккаунт создан',
    sendVerifyCode: 'Отправить код подтверждения',
    verifyCode: 'Код подтверждения',
    verifyCodeInputTips: 'Введите код подтверждения',
    retryInSeconds: 'Повторить через',
    verifyCodeSendSuccess: 'Код подтверждения отправлен на ваш',
    pleaseGetVerifyCodeFirst: 'Пожалуйста, сначала получите код подтверждения',
    verifyCodeRequired: 'Пожалуйста, введите код подтверждения',
    verifyCodeFormatError: 'Ошибка формата кода подтверждения',
    phone: 'Телефон',
    email: 'Электронная почта',
    directSignin: 'Уже есть аккаунт? Войти прямо сейчас',
    passwordResetOK: 'Пароль сброшен, пожалуйста, войдите снова',
    resetPassword: 'Сбросить пароль',
    bindPhone: 'Привязать телефон',
    inviteCode: 'Пригласительный код',
    inviteCodeInputTips:
        'Введите код приглашения друга и получите дополнительные награды (по желанию)',
    inviteCodeFormatError: 'Ошибка формата пригласительного кода',
    my: 'Мой',
    coinsUsage: 'Использование',
